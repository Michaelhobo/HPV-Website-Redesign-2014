...
var w = $(".option").width();
var expanded = false;
$(".option").css("height", w + "px");
$(".other-options").css("height", w);
/** The options animation. */
$(function() {
        $(".option").click(function(event) {
            if (!expanded) {
            $(".other-options").css("margin", "4%");
...
/** fade in and out the header-floating */
$("#contentwrapper").scroll(function() {
    if($("#contentwrapper").scrollTop() > winHeight * 0.15) {
        $(".header-floating").fadeIn();
    } else {
