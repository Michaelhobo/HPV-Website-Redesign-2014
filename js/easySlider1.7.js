...
numericId: 		'controls'
 ...
 $(".slider").each(function() {  
         ...
         var ts = s-1;
         var t = 0;
         $("#" + objId + " ul", obj).css('width',s*w);			

         if(options.continuous){
         $("#" + objId + " ul", obj).prepend($("ul li:last-child", obj).clone().css("margin-left","-"+ w +"px"));
         $("#" + objId + " ul", obj).append($("ul li:nth-child(2)", obj).clone());
         $("#" + objId + " ul", obj).css('width',(s+1)*w);
         };				
         console.debug("continuous");
         if(!options.vertical) $("#" + objId + " li", obj).css('float','left');
         ...
         function animate(dir,clicked){
             if (clickable){
                 ...
                 if(!options.vertical) {
                     ...
                     console.log("animate: " + $("ul",obj).css("margin"));
                 } else {
                     p = (t*h*-1);
                     $("ul",obj).animate(
                             { marginTop: p }, 
