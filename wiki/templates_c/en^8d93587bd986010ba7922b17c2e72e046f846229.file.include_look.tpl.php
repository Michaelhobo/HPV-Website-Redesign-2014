<?php /* Smarty version Smarty-3.1-DEV, created on 2013-10-09 17:35:23
         compiled from "/var/www/html/wordpress/tiki/templates/admin/include_look.tpl" */ ?>
<?php /*%%SmartyHeaderCode:201656798525593db4a6a10-69489853%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8d93587bd986010ba7922b17c2e72e046f846229' => 
    array (
      0 => '/var/www/html/wordpress/tiki/templates/admin/include_look.tpl',
      1 => 1366251530,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '201656798525593db4a6a10-69489853',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_525593db88a0d8_24579170',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_525593db88a0d8_24579170')) {function content_525593db88a0d8_24579170($_smarty_tpl) {?><?php if (!is_callable('smarty_block_tabset')) include 'lib/smarty_tiki/block.tabset.php';
...
" alt="Theme Screenshot" id="style_thumb" width="160px" height="120px">
				</div>
...
initThemeGenDialog();<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_jq(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
			...
			<fieldset>
				...
				<div class="adminoptionboxchild">
					<?php $_smarty_tpl->smarty->_tag_stack[] = array('self_link', array('_onclick'=>"show_brosho();return false;",'_ajax'=>"n")); $_block_repeat=true; echo smarty_block_self_link(array('_onclick'=>"show_brosho();return false;",'_ajax'=>"n"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php echo smarty_function_icon(array('_id'=>"bricks"),$_smarty_tpl);?>
Experimental: CSS assistant (work in progress - click the x to remove)<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_self_link(array('_onclick'=>"show_brosho();return false;",'_ajax'=>"n"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
