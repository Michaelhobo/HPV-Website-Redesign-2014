<?php /* Smarty version Smarty-3.1-DEV, created on 2013-10-10 08:46:02
         compiled from "/var/www/html/wordpress/tiki/templates/list_file_gallery.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14056318725256694a9a0a54-18648700%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '904f0a761aaaa3e71339a8b62e0fa3c1ac1fd5a0' => 
    array (
      0 => '/var/www/html/wordpress/tiki/templates/list_file_gallery.tpl',
      1 => 1362118800,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14056318725256694a9a0a54-18648700',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5256694ad9dfd6_01240019',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5256694ad9dfd6_01240019')) {function content_5256694ad9dfd6_01240019($_smarty_tpl) {?><?php if (!is_callable('smarty_function_icon')) include 'lib/smarty_tiki/function.icon.php';
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_pagination_links(array('cant'=>$_smarty_tpl->tpl_vars['cant']->value,'step'=>$_smarty_tpl->tpl_vars['maxRecords']->value,'offset'=>$_smarty_tpl->tpl_vars['offset']->value), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
			...
			<form name="fgalformid" id="fgalform" method="post" action="<?php if (!empty($_smarty_tpl->tpl_vars['filegals_manager']->value)){?><?php echo smarty_function_query(array('_type'=>'relative','filegals_manager'=>htmlspecialchars($_smarty_tpl->tpl_vars['filegals_manager']->value, ENT_QUOTES, 'UTF-8', true)),$_smarty_tpl);?>
<?php }else{ ?><?php echo smarty_function_query(array('_type'=>'relative'),$_smarty_tpl);?>
