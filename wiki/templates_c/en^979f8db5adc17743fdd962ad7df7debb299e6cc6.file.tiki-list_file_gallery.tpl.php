<?php /* Smarty version Smarty-3.1-DEV, created on 2013-10-10 08:46:02
         compiled from "/var/www/html/wordpress/tiki/templates/tiki-list_file_gallery.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7178205635256694a29fb18-84649907%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '979f8db5adc17743fdd962ad7df7debb299e6cc6' => 
    array (
      0 => '/var/www/html/wordpress/tiki/templates/tiki-list_file_gallery.tpl',
      1 => 1365444723,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7178205635256694a29fb18-84649907',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5256694a944f31_26128335',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5256694a944f31_26128335')) {function content_5256694a944f31_26128335($_smarty_tpl) {?><?php if (!is_callable('smarty_block_title')) include 'lib/smarty_tiki/block.title.php';
...
">
		...
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['tiki_p_admin_file_galleries']->value=='y'||($_smarty_tpl->tpl_vars['user']->value==$_smarty_tpl->tpl_vars['gal_info']->value['user']&&$_smarty_tpl->tpl_vars['gal_info']->value['type']=='user'&&$_smarty_tpl->tpl_vars['tiki_p_userfiles']->value)){?>
		...
		<?php if ($_smarty_tpl->tpl_vars['edit_mode']->value!='y'&&$_smarty_tpl->tpl_vars['dup_mode']->value!='y'){?>
			<?php if ($_smarty_tpl->tpl_vars['prefs']->value['javascript_enabled']=='y'){?>
				<select style="float:right;margin-top:0;" id="viewSwitcher">
					<option value="list"<?php if ($_smarty_tpl->tpl_vars['view']->value=='list'){?> selected="selected"<?php }?>>
						List Gallery
					</option>
					<option value="browse"<?php if ($_smarty_tpl->tpl_vars['view']->value=='browse'){?> selected="selected"<?php }?>>
						Browse Images
					</option>
					<?php if ($_smarty_tpl->tpl_vars['filescount']->value>0){?>
						<option value="page"<?php if ($_smarty_tpl->tpl_vars['view']->value=='page'){?> selected="selected"<?php }?>>
							Page View
						</option>
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['tiki_p_admin_file_galleries']->value=='y'){?>
						<option value="admin"<?php if ($_smarty_tpl->tpl_vars['view']->value=='admin'){?> selected="selected"<?php }?>>
							Admin View
						</option>
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['prefs']->value['fgal_elfinder_feature']=='y'){?>
						<option value="finder"<?php if ($_smarty_tpl->tpl_vars['view']->value=='finder'){?> selected="selected"<?php }?>>
							Finder View
						</option>
					<?php }?>
				</select>
