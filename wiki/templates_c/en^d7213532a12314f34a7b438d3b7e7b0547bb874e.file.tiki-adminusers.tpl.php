<?php /* Smarty version Smarty-3.1-DEV, created on 2013-10-09 16:48:38
         compiled from "/var/www/html/wordpress/tiki/templates/tiki-adminusers.tpl" */ ?>
<?php /*%%SmartyHeaderCode:567600110525588e6738742-59704020%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd7213532a12314f34a7b438d3b7e7b0547bb874e' => 
    array (
      0 => '/var/www/html/wordpress/tiki/templates/tiki-adminusers.tpl',
      1 => 1371332360,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '567600110525588e6738742-59704020',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_525588e721cce0_88709234',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_525588e721cce0_88709234')) {function content_525588e721cce0_88709234($_smarty_tpl) {?><?php if (!is_callable('smarty_block_title')) include 'lib/smarty_tiki/block.title.php';
...
" <?php if ($_smarty_tpl->tpl_vars['filterGroup']->value==$_smarty_tpl->tpl_vars['all_groups']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ix']['index']]){?>selected<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['all_groups']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ix']['index']], ENT_QUOTES, 'UTF-8', true);?>
					...
					<td><label for="filterEmailNotConfirmed">Email not confirmed</label></td>
					<td><input id="filterEmailNotConfirmed" name="filterEmailNotConfirmed" type="checkbox"<?php if (!empty($_REQUEST['filterEmailNotConfirmed'])){?> checked="checked"<?php }?>></td>
					<td><label for="filterNeverLoggedIn">Never logged in</label></td>
					<td><input id="filterNeverLoggedIn" name="filterNeverLoggedIn" type="checkbox"<?php if (!empty($_REQUEST['filterNeverLoggedIn'])){?> checked="checked"<?php }?>></td>
				</tr>
				<tr>
...
"></td>
					<td><label for="filterNotValidated">User not validated</label></td>
					<td><input id="filterNotValidated" name="filterNotValidated" type="checkbox"<?php if (!empty($_REQUEST['filterNotValidated'])){?> checked="checked"<?php }?>></td>
					<td></td>
					<td></td>
				</tr>
			</table>
